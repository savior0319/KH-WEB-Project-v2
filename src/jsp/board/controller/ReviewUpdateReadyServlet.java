...
/**
 * Servlet implementation class ReviewUpdateReadyServlet
 */
@WebServlet(name = "ReviewUpdateReady", urlPatterns = { "/reviewUpdateReady" })
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//1.인코딩
			...
			//2.view에서 보낸 데이터를 변수에 저장
				...
				//4.view에 결과 출력
				if(board!=null) {
					RequestDispatcher view = request.getRequestDispatcher("/View/board/reviewUpdate.jsp");

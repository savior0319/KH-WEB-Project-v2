		...
		<div class="ui attached segment">
			...
			<div class="ui form">
				<div class="field">
					...
					<textarea rows="13" readonly="readonly">
제 1 장 : 총칙 
제 2 장 : 서비스 이용계약 
제 3 장 : 계약당사자의 의무 
제 4 장 : 서비스 이용 
...
제1조(목적)
이 약관은 The Pension 에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
			...
			<div class="inline fields">
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="agreementChk1" class="agreement" id="agreement1">
						<label>동의합니다</label>
					</div>
					<div class="ui radio checkbox">
						<input type="radio" name="agreementChk1" class="nonAgreement" id="nonAgreement1">
...
신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)                                            					
			...
			<div class="inline fields">
				<div class="field">
					<div class="ui radio checkbox">
						<input type="radio" name="agreementChk2" class="agreement" id="agreement2">
						<label>동의합니다</label>
					</div>
					<div class="ui radio checkbox">
						<input type="radio" name="agreementChk2" class="nonAgreement" id="nonAgreement2">
						<label> 동의하지 않습니다</label>
					</div>
				</div>
			</div>
		...
		<div class="ui centered grid" style="border: none">
			<button class="ui teal button" id="signup">
				<i class="edit outline icon"></i> 가입하기
			</button>

			<button class="ui orange button" id="back">
				<i class="reply icon"></i> 뒤로가기
			</button>
		</div>
	</div>
	<!-- 본문 끝 -->
...
<!-- 모달 -->
<div class="ui mini modal" id="radioCheckModal">
	<div class="header">약관동의</div>
	<div class="content">
		<p>회원가입을 하시려면 약관에 모두 동의해주세요</p>
	</div>
	<div class="actions">

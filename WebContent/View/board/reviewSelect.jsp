	...
	<div class="ui container">
		...
		<div class="ui center aligned segment">
			...
			<div class="ui left aligned basic segment" style="margin-bottom: 0px;">
				<span class="ui large header" style="display: inline-block; width: 70%; margin-bottom: 5px;"><i class="bullhorn icon"></i>[후기] <%=btlv.getBv().getBdName()%></span>
			...
			<div class="ui medium header">후기내용</div>
				...
				<form action="/reviewUpdateReady" style="display:inline;">
					<input type="hidden" name="bdNo" value="<%=btlv.getBv().getBdNo()%>" />
					<input type="submit" class="ui orange button" value="글 수정">
				</form>

	...
	<div class="ui container">
		...
		<div class="ui center aligned segment">
			...
			<div class="ui left aligned basic segment" style="margin-bottom: 0px;">
				<span class="ui large header" style="display: inline-block; width: 70%; margin-bottom: 5px;"><i class="bullhorn icon"></i>[공지] <%=board.getBdName()%></span>
				<div class="ui divider"></div>
				<span class="ui small header" style="margin-right: 15px;"><i class="user icon"></i>작성자</span><span style="display: inline-block; width: 20%;"><%=board.getBdWriter()%></span><span class="ui small header" style="margin-right: 15px;"><i class="calendar icon"></i>작성일</span>
				<span style="display: inline-block; width: 20%;"><%=date%></span><span class="ui small header" style="margin-right: 15px;">
					...
					<span style="display: inline-block; width: 20%;"><%=board.getBdViewCount() %></span>
					<div class="ui divider"></div>
				</div>
